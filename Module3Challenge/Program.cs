...
namespace ZooAnimalsAssignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Ternary operator to output animal sounds
            ...
            switch (dayOfTheWeek) {
                ...
                case 6:
                    ...
                    break;
                case 5:
                    Console.WriteLine("Dont be so hard on yourself and come by for turtle Thursday!");
                    break;
                case 4:
                    Console.WriteLine("Take a big splash at out new whale Wendsday show!");
                    break;
                case 3:
                ...
                case 2:
                    ...
                    break;
                case 1:
                    Console.WriteLine("Slither on over for serpant Sunday here at the Zoo!");  
                    break;  
            }
